    ...
    <div class="col-md-8 offset-md-2">
      @include('admin.partials._alerts')
        <div class="block">
            ...
            <form action="{{ route('admin.wereyimages.store') }}" method="post" enctype="multipart/form-data" class="text-center">

                {{ csrf_field() }}
                <div class="inImage" style="margin:auto;background-image: url({{ asset('assets/admin/images/photo34.jpg') }})" id="preview">
                    <div class="cdx">
                        <button type="button" class="sky1"><span class="fa fa-image"></span> Choose Image</button>
                    </div>
               ...
               <div class="form-group">
                  <button type="submit" class="btn btn-alt-primary" style="margin-top:1rem;">Save Image</button>
               </div>
            </form>
          </div>
       </div>

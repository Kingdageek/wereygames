...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    ...
    <body>
       <div id="page-container" class="sidebar-o side-scroll @yield('nav_class') main-content-boxed">

            @include('admin.partials._admin-sidebar')

            @include('admin.partials._admin-header')
